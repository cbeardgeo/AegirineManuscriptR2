...
Drift corrections and data reduction were conducted with the iolite v2.5 extension for Igor Pro \citep{Paton2011}. The total of major-elements measured by LA-ICP-MS or, where available, the Al concentration from electron-microprobe analyses, was used as an internal standard (\ref{Ae_SupTbl}). For some experiments, ablation through the minerals was too rapid to generate a stable signal for data-reduction purposes. In these cases, a mixing model was applied to estimate the composition of these clinopyroxene, similar to those applied by \citet[][and see our \ref{LaserMix}]{Rubatto2007,Yang2018}.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{tabular}{@{}lllllllllll@{}}
\toprule
\emph{Clinopyroxene}  & L$4_3$ & M$3_2$ & M$5_2$ & H$5_3$ & NLS-9 & NLS-$9_2HM$ & \begin{tabular}[c]{@{}l@{}}16-07\\ LMB\end{tabular} & \begin{tabular}[c]{@{}l@{}}17-12\\ M. Samara\end{tabular} & \begin{tabular}[c]{@{}l@{}}17-14\\ UMB-II\end{tabular} & \begin{tabular}[c]{@{}l@{}}21-30\\ PV 2 ka\end{tabular} \\ \midrule
...
\begin{table}[htpb]
\centering
\caption{Clinopyroxene-melt trace-element-partition coefficients for representative experiments and a natural phenocryst-glass pair.}
\label{D_table}
\begin{adjustbox}{max width=\textwidth}
